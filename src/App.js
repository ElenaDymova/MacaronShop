  ...
  return (
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        <h1 className="mb-40">All desserts</h1>

        <div className="d-flex">
          <div className="card">
            <img width={133} height={112} src="/img/macarons/macaron1.png" alt="Macarons"/>
            <h5>Сезонный вкус: молочный шоколад, отборные свежие бананы</h5>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/macarons/macaron3.png" alt="Macarons"/>
            <h5>Сезонный вкус: молочный шоколад, отборные свежие бананы</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Price:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/macarons/macaron4.png" alt="Macarons"/>
            <h5>Сезонный вкус: молочный шоколад, отборные свежие бананы</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Price:</span>
